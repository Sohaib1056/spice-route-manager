...
export default function AboutSection() {
  ...
  const count100 = useCountUp(statsInView ? 100 : 0, 1500);
  const count500 = useCountUp(statsInView ? 500 : 0, 1500);
  const count2 = useCountUp(statsInView ? 2 : 0, 1500);
  ...
  return (
    <section id="about" className="bg-white py-12 md:py-20 scroll-mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Features Grid */}
        <div ref={statsRef} className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-16">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="bg-primary-soft border border-border rounded-2xl p-6 text-center hover:shadow-lg transition-all duration-300"
        ...
        {/* About Content */}
        <div ref={contentRef} className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          {/* Left Column - Content */}
          <motion.div
            initial={prefersReducedMotion ? {} : { opacity: 0, x: -60 }}
            animate={contentInView && !prefersReducedMotion ? { opacity: 1, x: 0 } : {}}
          ...
          >
            <div className="relative group">
              ...
              <motion.div 
                ...
                className="absolute -bottom-6 -right-6 bg-white rounded-2xl p-4 shadow-2xl border border-border/50 backdrop-blur-sm z-10"
                style={{ willChange: 'transform' }}
              >
